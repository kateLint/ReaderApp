...
import com.compose.readerapp.components.RatingBar
import com.compose.readerapp.components.ReaderAppBar
import com.compose.readerapp.components.RoundedButton
import com.compose.readerapp.components.ShowAlertDialog
import com.compose.readerapp.components.showToast
...
import com.compose.readerapp.utils.formatDate
...
@Composable
fun ReaderBookUpdateScreen(navController: NavHostController, bookItemId: String, viewModel: HomeScreenViewModel = hiltViewModel()) =
    Scaffold (topBar = {
        ...
        val bookInfo = produceState<DataOrException<List<MBook>,
                Boolean,Exception>>(initialValue = DataOrException(data = emptyList(),
                    true, Exception(""))){
